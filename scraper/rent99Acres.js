...
const rentScraper = async (city, cityId) => {
  if (!cityId) {
    throw new Error("Missing required query parameters: cityId and keyword");
  }

  const url = `https://www.99acres.com/search/property/rent/${city}?city=${cityId}&preference=R&res_com=R`;
